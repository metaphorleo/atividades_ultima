    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dia_reserva', models.DateField(help_text='dd/mm/aaaa', verbose_name='Dia da reserva')),
                ('turno', models.CharField(choices=[('manhça', 'Manhã'), ('tarde', 'Tarde')], max_length=10, verbose_name='Turno')),
